...
urlpatterns = [
    ...
    path('dashboard/homepage/testimonial/<int:testimonial_id>/approve/', views.admin_approve_testimonial_view, name='admin_approve_testimonial'),
    path('dashboard/homepage/testimonial/<int:testimonial_id>/reject/', views.admin_reject_testimonial_view, name='admin_reject_testimonial'),
    ...
    path('my-testimonials/<int:testimonial_id>/delete/', views.delete_my_testimonial_view, name='delete_my_testimonial'),
