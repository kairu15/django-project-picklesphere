...
urlpatterns = [
    ...
    path('org-admin/', views.staff_payments_view, name='staff_payments'),
    path('org-admin/verify/<int:payment_id>/', views.verify_payment_view, name='verify_payment'),
    path('org-admin/cash-confirm/<int:payment_id>/', views.cash_payment_confirmation_view, name='cash_payment_confirm'),
