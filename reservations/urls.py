...
urlpatterns = [
    ...
    path('org-admin/', views.staff_reservations_view, name='staff_reservations'),
    path('org-admin/cancellations/', views.staff_cancellations_view, name='staff_cancellations'),
    path('org-admin/refunds/', views.staff_refund_processing_view, name='staff_refund_processing'),
    path('org-admin/refunds/history/', views.staff_refund_history_view, name='staff_refund_history'),
    path('org-admin/<int:reservation_id>/approve/', views.approve_reservation_view, name='approve_reservation'),
